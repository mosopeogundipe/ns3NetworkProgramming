...
#ifndef DRR_APPLICATION_CLIENT_H
#define DRR_APPLICATION_CLIENT_H
...
namespace ns3 {
	...
	class DrrApplicationClient : public Application
	{
	public:
		static TypeId GetTypeId(void);

		DrrApplicationClient();

		virtual ~DrrApplicationClient();
