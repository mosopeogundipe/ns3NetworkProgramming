...
#ifndef PROTOCOL_PACKET_FILTER_H
#define PROTOCOL_PACKET_FILTER_H
 ...
 *
 */
class ProtocolPacketFilter: public Object {
public:
  /**
  ...
  ProtocolPacketFilter (uint8_t proto);
  virtual ~ProtocolPacketFilter ();
