...
#ifndef PROTOCOL_FILTER_ELEMENT_H
#define PROTOCOL_FILTER_ELEMENT_H
 ...
 *
 */
class ProtocolFilterElement: public FilterElement {
public:
  /**
  ...
  ProtocolFilterElement (uint8_t proto);
  virtual ~ProtocolFilterElement ();
