...
#ifndef DEST_PORT_PACKET_FILTER_H
#define DEST_PORT_PACKET_FILTER_H
 ...
 *
 */
class DestPortPacketFilter: public Object {
public:
  /**
  ...
  DestPortPacketFilter (uint32_t portNumber);
  virtual ~DestPortPacketFilter ();
