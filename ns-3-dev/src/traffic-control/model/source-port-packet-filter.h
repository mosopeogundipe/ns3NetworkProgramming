...
#ifndef SOURCE_PORT_PACKET_FILTER_H
#define SOURCE_PORT_PACKET_FILTER_H
 ...
 *
 */
class SourcePortPacketFilter: public Object {
public:
  /**
  ...
  SourcePortPacketFilter (uint32_t portNumber);
  virtual ~SourcePortPacketFilter ();
...
#endif /* SOURCE_PORT_PACKET_FILTER */
