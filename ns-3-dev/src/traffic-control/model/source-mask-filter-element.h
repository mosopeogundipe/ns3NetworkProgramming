...
#ifndef SOURCE_MASK_FILTER_ELEMENT_H
#define SOURCE_MASK_FILTER_ELEMENT_H
 ...
 *
 */
class SourceMaskFilterElement: public FilterElement {
public:
  /**
  ...
  SourceMaskFilterElement (Ipv4Address startAddr, Ipv4Address endAddr);
  virtual ~SourceMaskFilterElement ();
...
#endif /* SOURCE_MASK_FILTER_ELEMENT */
