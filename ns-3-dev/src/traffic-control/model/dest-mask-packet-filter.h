...
#ifndef DEST_MASK_PACKET_FILTER_H
#define DEST_MASK_PACKET_FILTER_H
 ...
 *
 */
class DestMaskPacketFilter: public Object {
public:
  /**
  ...
  DestMaskPacketFilter (Ipv4Address addr, Ipv4Mask ipMask);
  virtual ~DestMaskPacketFilter ();
