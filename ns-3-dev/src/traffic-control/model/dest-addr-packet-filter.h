...
#ifndef DEST_ADDR_PACKET_FILTER_H
#define DEST_ADDR_PACKET_FILTER_H
 ...
 *
 */
class DestAddrPacketFilter: public Object {
public:
  /**
  ...
  DestAddrPacketFilter (Ipv4Address address);
  virtual ~DestAddrPacketFilter ();
