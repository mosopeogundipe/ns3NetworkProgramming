...
#ifndef SOURCE_MASK_PACKET_FILTER_H
#define SOURCE_MASK_PACKET_FILTER_H
 ...
 *
 */
class SourceMaskPacketFilter: public Object {
public:
  /**
  ...
  SourceMaskPacketFilter (Ipv4Address addr, Ipv4Mask ipMask);
  virtual ~SourceMaskPacketFilter ();
...
#endif /* SOURCE_MASK_PACKET_FILTER */
