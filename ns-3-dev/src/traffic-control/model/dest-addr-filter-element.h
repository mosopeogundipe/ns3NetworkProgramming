...
#ifndef DEST_ADDR_FILTER_ELEMENT_H
#define DEST_ADDR_FILTER_ELEMENT_H
 ...
 *
 */
class DestAddrFilterElement: public FilterElement {
public:
  /**
  ...
  DestAddrFilterElement (Ipv4Address address);
  virtual ~DestAddrFilterElement ();
...
#endif /* DEST_ADDR_FILTER_ELEMENT */
