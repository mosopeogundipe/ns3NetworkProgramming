...
#ifndef SOURCE_PORT_FILTER_ELEMENT_H
#define SOURCE_PORT_FILTER_ELEMENT_H
 ...
 *
 */
class SourcePortFilterElement: public FilterElement {
public:
  /**
  ...
  SourcePortFilterElement (uint32_t portNumber);
  virtual ~SourcePortFilterElement ();
...
#endif /* SOURCE_PORT_FILTER_ELEMENT */
